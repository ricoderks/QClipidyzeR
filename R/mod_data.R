  ...
  moduleServer( id, function(input, output, session){
    ...
    output$data_sheet1 <- DT::renderDT({
      ...
      if(!is.null(r$all_data)) {
        show_data <- r$clean_data$clean_data[[1]]
    ...
    output$data_sheet2 <- DT::renderDT({
      ...
      if(!is.null(r$all_data)) {
        show_data <- r$clean_data$clean_data[[2]]
    ...
    output$data_sheet3 <- DT::renderDT({
      ...
      if(!is.null(r$all_data)) {
        show_data <- r$clean_data$clean_data[[3]]
    ...
    output$data_sheet4 <- DT::renderDT({
      ...
      if(!is.null(r$all_data)) {
        show_data <- r$clean_data$clean_data[[4]]
    ...
    output$data_sheet5 <- DT::renderDT({
      ...
      if(!is.null(r$all_data)) {
        show_data <- r$clean_data$clean_data[[5]]
    ...
    output$data_sheet6 <- DT::renderDT({
      ...
      if(!is.null(r$all_data)) {
        show_data <- r$clean_data$clean_data[[6]]
